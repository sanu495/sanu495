...
Backend developer with hands-on experience building production-grade REST APIs using Python and FastAPI. Completed a structured internship at **Nexsofture** (NexSkillup Program) where I designed and shipped two backend systems from scratch — covering authentication, layered architecture, and database design.
